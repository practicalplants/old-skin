...
$wgValidSkinNames['practicalplants'] = 'PracticalPlants';


$ppResourceTemplate = array(
	'localBasePath' => dirname( __FILE__ ).'/resources',
	'remoteBasePath' => $GLOBALS['wgStylePath'].'/'.basename(__DIR__).'/resources',
	//'remoteExtPath' => $GLOBALS['wgStylePath'].'/'.basename(__DIR__).'/resources',
	//'group' => 'skin.practicalplants'
);

$wgResourceModules += array(
	'bootstrap.js'=>$ppResourceTemplate + array(
		'scripts' => array('bootstrap/js/bootstrap.min.js'),
		'position' => 'top'
	),
	'skin.practicalplants.css'=>$ppResourceTemplate + array(
					'styles' => array(
						'css/main.css'=>array('media'=>'screen'),
						'css/print.css'=>array('media'=>'print'),
						'css/global.css'=>array('media'=>'screen'),
						'css/masthead.css'=>array('media'=>'screen')
					),
					'position'=>'top'
 ),
	...
	'skin.practicalplants.init.dom' => $ppResourceTemplate + array(
		'scripts' => array(
	...
	'browserupdate' => $ppResourceTemplate + array(
		'scripts'=> array('js/browserupdateerupdate.js')
	),
	'skin.practicalplants.init' => $ppResourceTemplate + array(
		'scripts' => array(
	...
	'skin.practicalplants.page.main'=> $ppResourceTemplate + array(
		'scripts' => array('js/practicalplants.page.main-discover.js'),
		'dependencies' => array( 'jquery.cookie')
	),
	'skin.practicalplants.page.search'=> $ppResourceTemplate + array(
		'scripts' => array('js/practicalplants.page.search-discover.js'),
		'dependencies' => array( 'jquery.cookie','skin.practicalplants.init')
	),
...
$wgHooks['BeforePageDisplay'][] = function( OutputPage &$out, Skin &$skin ) {
	global $ppResourceTemplate;
	//echo '<pre>'; print_r($out); exit;
	if ( true ) {
		$out->addModules( 'skin.practicalplants.css' );
		$out->addModules( 'skin.practicalplants.init.dom' );
		$out->addModules( 'browserupdate' );
		$out->addModules( 'skin.practicalplants.init' );
		$out->addStyle( $ppResourceTemplate['remoteBasePath'].'/fonts/crete-round/stylesheet.css', 'screen' );
		...
		switch($title){
			...
			case 'Main page':
			case 'Main Page':
				$out->addModules('skin.practicalplants.page.main');
				break;
			case 'Search':
				$out->addModules('skin.practicalplants.page.search');
		}
	}
